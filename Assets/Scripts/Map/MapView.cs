...
namespace Map
{
    public class MapView : MonoBehaviour
    {
        ...
        public float startMapPositionOffset;
        ...
        protected virtual void SetOrientation()
        {
            ...
            switch (orientation)
            {
                case MapOrientation.BottomToTop:
                    if (scrollNonUi != null)
                    {
                        scrollNonUi.yConstraints.max = startMapPositionOffset;
                        scrollNonUi.yConstraints.min = -(span + 2f * offset);
                    }
                    mapParent.transform.localPosition += new Vector3(0, startMapPositionOffset, 0);
                    break;
                case MapOrientation.TopToBottom:
                    mapParent.transform.eulerAngles = new Vector3(0, 0, 180);
                    if (scrollNonUi != null)
                    {
                        scrollNonUi.yConstraints.min = -startMapPositionOffset;
                ...
                case MapOrientation.RightToLeft:
                    ...
                    // factor in map span:
                    mapParent.transform.localPosition -= new Vector3(startMapPositionOffset, 0, 0);
                    if (scrollNonUi != null)
                    {
                        scrollNonUi.xConstraints.max = span + 2f * offset;
                        scrollNonUi.xConstraints.min = -startMapPositionOffset;
                    }
                    break;
                case MapOrientation.LeftToRight:
                    ...
                    if (scrollNonUi != null)
                    {
                        scrollNonUi.xConstraints.max = startMapPositionOffset;
